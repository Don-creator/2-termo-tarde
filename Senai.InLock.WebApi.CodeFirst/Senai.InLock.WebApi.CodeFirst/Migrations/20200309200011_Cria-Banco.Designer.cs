...
namespace Senai.InLock.WebApi.CodeFirst.Migrations
{
    ...
    [Migration("20200309200011_Cria-Banco")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Senai.InLock.WebApi.CodeFirst.Domains.Jogos", b =>
                {
                    ...
                    b.HasData(
                        new { IdJogo = 1, DataLancamento = new DateTime(2012, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), Descricao = "É um jogo que contem bastanet ação e é viciante, seja você ", IdEstudio = 1, NomeJogo = "Diablo 3", Valor = 99.00m },
                        new { IdJogo = 2, DataLancamento = new DateTime(2018, 10, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), Descricao = "Jogo eletronico de ação e aventura western ", IdEstudio = 2, NomeJogo = "Red Dead Redemption 2", Valor = 120.00m }
                    );
                });

            modelBuilder.Entity("Senai.InLock.WebApi.CodeFirst.Domains.TiposUsuarios", b =>
                {
            ...
            modelBuilder.Entity("Senai.InLock.WebApi.CodeFirst.Domains.Usuarios", b =>
                {
                    b.HasOne("Senai.InLock.WebApi.CodeFirst.Domains.TiposUsuarios", "TiposUsuario")
                        .WithMany()
